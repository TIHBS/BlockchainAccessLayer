...
class EthereumAdapterTest {
    ...
    void testInvokeSmartContract() throws Exception {
        ...
        LinearChainTransaction init = (LinearChainTransaction) this.adapter.invokeSmartContract(smartContractPath, functionIdentifier, inputs, outputs, REQUIRED_CONFIDENCE, 50000).get();
        ...
        Transaction result = this.adapter.invokeSmartContract(smartContractPath, functionIdentifier, inputs, outputs, REQUIRED_CONFIDENCE, 50000).get();
