...
public interface BlockchainAdapter {
     ...
     */
    CompletableFuture<Transaction> submitTransaction(long waitFor, String receiverAddress, BigDecimal value) throws SubmitTransactionException;
     ...
     * @return a completable future that emits a summary of the received transaction
     */
